    ...
    <div class="navbar-header">
        ...
        <div class="navbar-logo-box">
            <a href="#" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="admin-assets/assets/images/logo-sm.png" alt="logo-sm-dark" height="20">
                    </span>
                <span class="logo-lg">
                        <img src="admin-assets/assets/images/logo-dark.png" alt="logo-dark" height="18">
                    </span>
            </a>

            <a href="index.html" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="admin-assets/assets/images/logo-sm.png" alt="logo-sm-light" height="20">
                    </span>
                <span class="logo-lg">
                        <img src="admin-assets/assets/images/logo-light.png" alt="logo-light" height="18">
                    </span>
            </a>
        ...
        <div class="d-flex justify-content-end menu-sm px-3">
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated shadow-lg overflow-hidden" style="min-width: 200px;">
